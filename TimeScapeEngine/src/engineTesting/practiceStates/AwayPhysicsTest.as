package engineTesting.practiceStates 
{
	 ...
	 * @author Saykrd
	 */
	public class AwayPhysicsTest extends AppState 
	{
		...
		public function AwayPhysicsTest(id:String = null) 
		{
			super(id);
			setStartCommand(init);
		}
		...
		private function init(e:Event = null):void 
		{
			...
			Main.STAGE.addEventListener(Event.ENTER_FRAME, handleEnterFrame);
		}
